...
public class frmListaPremiosPelicula  extends JInternalFrame implements ListSelectionListener {
     ...
     * @see ModeloListaV2
     */
    public frmListaPremiosPelicula() {
        setTitle("Lista de Premios Pelicula");
    ...
    public void valueChanged(ListSelectionEvent arg0) {
        ...
        if (arg0.getValueIsAdjusting() == false) {
            ...
            String TextoAMostrar = "clsPremios_Pelicula{" +
                    "ID Premios Pelicula= " + ((itfPropertyV2) jlista.getSelectedValue()).getObjectProperty("idPremios") +
                    ...
                    ", Titulo de la pelíocula= " + ((itfPropertyV2) jlista.getSelectedValue()).getObjectProperty("Películas_Título") +
                    '}';
