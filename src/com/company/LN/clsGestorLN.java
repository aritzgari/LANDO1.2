...
public class clsGestorLN {
    ...
    public static int crearPremiosPelicula(String Nombre, String Categoria, int A�o, String Pel�culas_T�tulo) {
        int retorno = 0;
        clsPremios_PeliculaBD objPremiosPeliculaBD = new clsPremios_PeliculaBD(Nombre, Categoria, A�o, Pel�culas_T�tulo);
    ...
    /**
     * M�todo para consultar editorial
     *
     * @return
     */
    ...
    /**
     * M�todo para consultar Pel�culas
     */
    ...
    /**
     * M�todo para consultar Librer�as
     */
    ...
    /**
     * M�todo para actualizar G�neros de pel�culas
     */
    ...
    /**
     * A partir de aqu� van lo que hemos llamado casteos.
    ...
    /**
     * M�todo para castear Premios Pelicula.
     */
